        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                <div class="news-image">
                    <img src="{{ asset('asset_admin/assets/img/login-bg/bg-2.jpg') }}" data-id="login-cover-image" alt="" />
                </div>
                <div class="news-caption">
                    <h4 class="caption-title"><i class="fa fa-diamond text-success"></i> 现在的年轻人</h4>
                    <p>
                       真是too young too sample1
                    </p>
                </div>
            </div>
            <!-- end news-feed -->
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <span class="logo"></span> SMS Admin
                        <small>更快,更高,更强</small>
                    </div>
                    <div class="icon">
