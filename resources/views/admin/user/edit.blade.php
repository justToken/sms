...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">修改签约用户</h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/user/'.$user['id']) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="sjhm">手机号码 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="sjhm" placeholder="手机号码" data-parsley-required="true" data-parsley-required-message="请输入手机号码" value="{{ $user['sjhm'] }}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="yhxm">用户姓名 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="yhxm" placeholder="用户姓名" data-parsley-length="[2,20]" data-parsley-length-message="姓名长度2~20字符" data-parsley-required="true" data-parsley-required-message="请输入姓名" value="{{ $user['yhxm'] }}"/>
                                </div>
                            </div>
                             <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="khh">银行账户 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="khh" placeholder="银行账户" data-parsley-required="true" data-parsley-required-message="请输入银行账户" value="{{ $user['khh'] }}"/>
                                </div>
                            </div> 
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                        ...
                                        <option value="0" @if($user['zjlx'] == 0) selected="selected" @endif >身份证</option>
                                        <option value="1" @if($user['zjlx'] == 1) selected="selected" @endif>居住证</option>
                                        <option value="2" @if($user['zjlx'] == 2) selected="selected" @endif>护照</option>
                                        <option value="3" @if($user['zjlx'] == 3) selected="selected" @endif>户口本</option>
                                        <option value="4" @if($user['zjlx'] == 4) selected="selected" @endif>军人证</option>
                                    </select>
                                    <p id="zjlx_error"></p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" id="zjhm" type="text" name="zjhm" placeholder="证件号码" data-parsley-length="[6,20]" data-parsley-length-message="证件号码长度6~20字符" data-parsley-required="true" data-parsley-required-message="请输入证件号码" value="{{ $user['zjhm'] }}"/>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                          ...
                                          <option value="">-- 请选择 --</option>
                                            ...
                                            <option value="{{ $group->id }}"  @if($group->id == $user['usergroup']) selected="selected" @endif>{{ $group->name }}</option>
                                            @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date form_date col-md-6 col-sm-6" data-date="" data-date-format="yyyy-mm-dd" data-link-field="qssj" data-link-format="yyyy-mm-dd" >
                                    <input class="form-control" size="16" type="text" value="{{ $user['qssj'] }}" data-parsley-required="true"
                                    data-parsley-errors-container="#qssj_error"
                                    data-parsley-required-message="请选起始时间" readonly>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                </div>
                                <p id="qssj_error"></p>
                                <input type="hidden" id="qssj" name="qssj"  value="{{ $user['qssj'] }}" />
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group date form_date col-md-6 col-sm-6" data-date="" data-date-format="yyyy-mm-dd" data-link-field="zzsj" data-link-format="yyyy-mm-dd" >
                                    <input  id="zzsj" class="form-control" size="16" type="text" value="{{ $user['zzsj'] }}" 
                                    data-parsley-required="true"
                                    data-parsley-required-message="请选择终止时间" readonly>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                   
                                </div>
                                <input type="hidden" id="zzsj" name="zzsj"  value="{{ $user['zzsj'] }}" />
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="dzyx">电子邮箱  :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" id="dzyx" type="text" name="dzyx" placeholder="电子邮箱" data-parsley-length="[7,20]" data-parsley-length-message="联系电话长度7~20字符" data-parsley-required="false" data-parsley-required-message="请输入联系电话" value="{{ $user['dzyx'] }}"/>
                                </div>
                            </div>
