            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/package') }}" method="POST">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <label class="control-label col-md-4 col-sm-4" for="tcmc">套餐名称 * :</label>
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="tcmc" placeholder="套餐名称" data-parsley-required="true" data-parsley-required-message="请输入套餐名称" value="{{ old('tcmc') }}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="byyz" placeholder="包月月租" data-parsley-required="true" data-parsley-required-message="请输入包月月租" value="{{ old('byyz') }}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                        ...
                                        <option value="0">按套餐</option>
                                        <option value="1">按短信类型</option>
                                        <option value="2">按套餐+短信类型</option>
                                    </select>
                                    <p id="jfdy_error"></p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                        ...
                                        <option value="2">按条数</option>
                                        <option value="3">包月封顶</option>
                                        <option value="4">按条封顶</option>
                                    </select>
                                    <p id="sffs_error"></p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select class="form-control selectpicker"
                                        ...
                                        <option value="2">下行-上行</option>
                                        <option value="3">下行+上行</option>
                                    </select>
                                    <p id="jfts_error"></p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input class="form-control" type="text" name="mfsj" placeholder="免费时间" data-parsley-required="false" data-parsley-required-message="请输入免费时间" value="{{ old('mfsj') }}"/>
                                </div>
                            </div>
                            <div class="form-group">
